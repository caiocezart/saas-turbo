import { EventBusAuth } from "../events/auth.event-bus";
...
import { ChangePasswordRequestDto, ErrorCode } from "@repo/domain";
import { AccountService } from "../services/account.service";
import { EventEmitter2 } from "@nestjs/event-emitter";
import { PasswordUpdatedEvent } from "../events";
...
export class ChangePasswordUseCase {
  ...
  async execute(request: RequestPayload, changePassword: ChangePasswordRequestDto ) {
